...
export const BetaTestCard = () => {
  return (
    <section className="flex h-[150px] w-[270px] flex-col gap-[5px] rounded px-[0.875rem] py-3 shadow-cardMobile md:gap-6 md:rounded-3xl md:px-[4rem] md:py-[3.5rem] md:shadow-cardWeb lg:h-[720px] lg:w-[1280px]">
...
export const IntroLadiCard = () => {
  return (
    <section className="flex h-[150px] w-[270px] flex-col gap-[5px] rounded shadow-cardMobile md:gap-6 md:rounded-3xl md:shadow-cardWeb lg:h-[720px] lg:w-[1280px]">
      <Image
        src={'/intro_ladi.png'}
        alt="라디 소개 이미지"
        width={270}
