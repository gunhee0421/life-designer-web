...
export const FooterFive = () => {
  return (
    <footer className="flex flex-col gap-6 md:gap-[3.75rem]">
      <p className="text-2xl font-bold md:text-5xl">
        동기부여,
        <br />
        가장 빠르고 정확한 방법은
      ...
      <p className="text-[1.25rem] text-textSecondary md:text-4xl">
        지금까지 수행했던 <br className="md:hidden" />
        모든 기록들을 확인해보세요.
      </p>
    </footer>
  )
...
export const FooterSeven = () => {
  return (
    <footer className="mx-[2.75rem] my-[3rem] flex flex-1 flex-col gap-9 font-sans font-bold md:ml-[15rem] md:mr-0 md:gap-[7.5rem]">
      ...
      <h1 className="text-2xl md:text-5xl">지금 바로 다운로드 하세요!</h1>
      <nav className="inline-flex flex-row gap-4">
        <a
          className="inline-flex items-center gap-2 rounded-md bg-black px-4 py-2 text-start md:px-8 md:py-4 md:pr-12"
          href="https://play.google.com/store/apps/details?id=dorun.com.life_designer_client&pcampaignid=web_share"
        >
          <Icon name="playstore" size={20} className="md:hidden" />
          <Icon name="playstore" size={40} className="hidden md:block" />
          <div className="text-white">
            <p className="text-[12px] font-medium md:text-2xl">Google Play</p>
          </div>
        </a>
        ...
        >
          <Icon name="apple" size={20} className="md:hidden" />
          <Icon name="apple" size={40} className="hidden md:block" />
          <div className="text-white">
            <p className="text-[12px] font-medium md:text-2xl">App Store</p>
          </div>
        </a>
      </nav>
    </footer>
...
export const IntroFooter = () => {
  return (
    <footer className="flex flex-col gap-4">
      <h1 className="text-[0.875rem] font-bold md:text-xl">
