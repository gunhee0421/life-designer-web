...
export const FooterThree = () => {
  return (
    <footer className="flex flex-col gap-3 lg:flex-1 lg:gap-[3.75rem]">
      <p className="text-2xl font-bold lg:text-4xl xl:text-5xl">
      ...
      <p className="text-[0.9375rem] font-medium text-textSecondary lg:text-2xl xl:text-4xl">
...
export const FooterFive = () => {
  return (
    <footer className="flex min-w-[270px] flex-col gap-6 lg:gap-[3.75rem]">
      <p className="text-2xl font-bold lg:text-4xl xl:text-5xl">
        동기부여,
        <br />
        가장 빠르고 정확한 방법은
      ...
      <p className="text-[1.25rem] font-medium text-textSecondary lg:text-2xl xl:text-4xl">
...
export const FooterSeven = () => {
  return (
    <footer className="mx-[2.75rem] my-[3rem] flex flex-col gap-9 font-sans font-bold lg:mr-0 lg:gap-[7.5rem]">
      <h2 className="text-xl lg:text-4xl xl:text-5xl">
        각각의 사용자에 맞춰
        <br />
        루틴 생성, 수행 그리고 기록까지
        <br />
      ...
      <h1 className="text-2xl lg:text-4xl xl:text-5xl">
        지금 바로 다운로드 하세요!
      </h1>
      <nav className="inline-flex flex-row gap-4">
        ...
        >
          ...
          <div className="text-white">
            <p className="text-[12px] font-medium xl:text-2xl">Google Play</p>
          </div>
        </a>
        ...
        >
          ...
          <div className="text-white">
            <p className="text-[12px] font-medium xl:text-2xl">App Store</p>
          </div>
        </a>
      </nav>
    </footer>
